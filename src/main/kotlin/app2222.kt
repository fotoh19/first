...
//      Items and quantity values
    ...
    println("----------------------")
    println("Do you have a discount on the bill?")
    val disqount = readLine().toString()
    ...
    if (disqount == "yes") {
        ...
        println("inter the disqount (%)")
        val disqountval = readLine()?.toInt()

        val finalTotalWithDisqount = finalTotal - ((finalTotal * disqountval!!)/100)
        println("------------")
        ...
        println("---------")
        println("Storage quntity items : $totalQuantity")
        println("The store contains a value befor disqount= $finalTotal")
        println("The store contains a value after disqount= $finalTotalWithDisqount")
        println("disqount :$disqountval%")
        println("---------")
